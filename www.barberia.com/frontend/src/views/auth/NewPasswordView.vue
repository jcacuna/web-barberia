...
<template>
    <div v-if="validToken">
        <h1 class="text-3xl font-extrabold text-white text-center mt-10">Nuevo Password</h1>
        <p class="text-1xl text-white text-center my-5">Coloca tu nuevo password</p>
        ...
        <FormKit id="newPasswordForm" type="form" :actions="false"
            ...
            <FormKit type="password" label="Password" name="password"
                placeholder="Password de Usuario - Min 8 Caracteres" validation="required|length:8"
                :validation-messages="{
